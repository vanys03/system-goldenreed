...
Route::get('/documento/{carpeta}/{archivo}', function ($carpeta, $archivo) {
    ...
    //Rutas de cliente de ventas, corte eh historia
...
// Clientes
Route::get('/estado-clientes', [ClientesController::class, 'estadoClientes'])
    ->name('estado_clientes.index');
...
Route::get('/reporte-clientes', [ClientesController::class, 'reporteClientes'])
    ->name('reporte_clientes.index');


// Ventas clientes
Route::get('/ventas-clientes', [VentasController::class, 'ventasClientes'])
    ->name('ventas_clientes.index');

Route::get('/ventas-clientes/filtrar', [VentasController::class, 'filtrarVentasClientes'])
    ->name('ventas_clientes.filtrar');


// Tickets
Route::get('/ticket/reimprimir/{id}', [TicketController::class, 'reimprimir'])
    ->name('ticket.reimprimir');

Route::get('/ventas/{venta}/ticket-a/{cliente}', [TicketController::class, 'tipoA'])
    ->name('tickets.tipo-a');

Route::get('/ventas/{venta}/ticket-b/{cliente}', [TicketController::class, 'tipoB'])
    ->name('tickets.tipo-b');

Route::get('/ventas/{venta}/ticket-c/{cliente}', [TicketController::class, 'tipoC'])
    ->name('tickets.tipo-c');

Route::get('/ventas/{venta}/ticket-generico/{cliente}', [TicketController::class, 'generico'])
    ->name('tickets.generico');

Route::get('/tickets/reimprimir/{id}', [TicketController::class, 'reimprimir'])
